...
- 🔭 Currently building **full-stack applications with Next.js 14**
...
![TypeScript](https://img.shields.io/badge/TypeScript-5.0-3178C6?style=for-the-flat&logo=typescript&logoColor=white)
...
- **Technologies**: ReactJS, PostgreSQL, TailwindCSS, ExpressJS
- **Role**: Frontend Developer – UI Design & Implementation
- **Achievements**:
  - Built responsive, user-friendly interface praised for clarity and ease of use
  - Successfully integrated frontend with backend APIs ensuring seamless data flow
  - Implemented modern design patterns for maintainable and scalable code
- **Team Size**: 5 members

### 🌟 [ChatBot Web Application](https://github.com/YOUR_USERNAME/project-2) | *In Process*
*AI Chatbot with real-time interaction and chat history*
- **Technologies**: ReactJS, NextJS, TailwindCSS, Radix UI
- **Role**: Frontend Developer – UI Design & Component Development
- **Responsibilities**: Building responsive chat interface, implementing real-time updates, and ensuring optimal user experience
- **Team Size**: 4 members

### 💡 [Visual Novel Website](https://github.com/YOUR_USERNAME/project-3) | *2025*
*AI-powered interactive storytelling platform*
- **Technologies**: ReactJS, FastAPI, LangChain, PostgreSQL, TailwindCSS
- **Role**: Frontend Developer – UI/UX Design & AI Integration Support
- **Achievements**:
  - Successfully delivered project on schedule with Docker deployment
  - Received positive feedback from instructors for intuitive UI and smooth user experience
  - Implemented responsive design supporting multiple device types
- **Team Size**: 4 members
